...
class UserController {
    ...
    async assignPermission(req, res) {
        const user = await UserService.assignPermission(req.body.userId, req.body.permissionId);
        if (!user) {
            ResponseService.error(
                res,
    ...
    async removePermission(req, res) {
        const user = await UserService.removePermission(req.body.userId, req.body.permissionId);
        if (!user) {
            ResponseService.error(
                res,
